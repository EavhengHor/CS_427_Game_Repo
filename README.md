...
* **Watch:** [Catch the Potato Gameplay Video]
* https://youtu.be/x98EBDHUaZI
...
* **SGenerative Imange:**Mostly button and logo are generated by AI (gemini banana pro).
...
1. **Download:** Grab the latest release ZIP file from the [Releases](https://github.com/EavhengHor/CS_427_Game_Repo/releases/tag/V1) section.
