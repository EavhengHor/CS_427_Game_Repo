...
## Check this box only in the Boss Level scene via the Inspector
@export var is_boss_level: bool = false

@export_category("Weapons & Shooting")
@export var blaster_i: Node3D
@export var blaster_d2: Node3D
